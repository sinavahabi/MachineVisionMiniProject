...
Features: Artificial Intelligence, Machine Learning, Machine Vision, Deep Learning, Tensorflow library, Image processing libraries, Image Classification, Image validation, Jupyter
